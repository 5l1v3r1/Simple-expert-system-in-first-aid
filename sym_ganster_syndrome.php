    ...
    <li><a href="user_update.php">แก้ไขข้อมูล</a></li>
     ...
     <div class="container">
      ...
      <div class="jumbotron">
        ...
        <p>
            โปรดเลือกลักษะอาการของผู้ป่วยตามหัวข้อด้านล่างนี้
        </p>
      </div>
      ...
      <div class="container">
        ...
        <?php
          ...
          $sql = "SELECT case_name,case_info FROM sym_cases_level1 where sym_id=5";
      ...
      <div class="jumbotron">
        ...
        <form action="sym_ganster_syndrome_result.php" method="GET">

        <div class="radio">
            
        <?php
          while($row = $result->fetch_assoc()) {
            echo '<label><input type="radio" name="case_name" value="'.$row["case_name"].'" required>' . $row["case_info"].'</label>' .'<br>';
          }
          } else {
            echo "0 results";
          }
