  ...
  <ul class="dropdown-menu">
    ...
    <div class="container">
      ...
      <div class="jumbotron">
        ...
        <p>
        	โปรดเลือกกรณีย่อย ของผู้ป่วยตามหัวข้อด้านล่างนี้
          <font color="red">***ในกรณีที่ไม่พบกรณีย่อยย ในกดถัดไปเพื่อทราบวิธีการปฐมพยาบาลได้เลย</font>
        </p>
      </div>
...
<div class="jumbotron">
        ...
        <form action="sym_danger_zone_result.php" method="GET">
    ...
    <button class="btn btn-default" ><a href="sym_danger_zone.php">ย้อนกลับ</a></button> 
