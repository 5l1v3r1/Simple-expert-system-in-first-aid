  ...
  <ul class="dropdown-menu">
   ...
   <?php
    ...
    <?php
          ...
          $sql = "SELECT case_info,case_sym_flag FROM sym_cases_level1 where case_name='".$case."'";
    ...
    <div class="container">
      ...
      <div class="jumbotron">
        <h2>สารพิษ (สัตว์)</h2>
        ชนิดของสัตว์ที่ทำอันตรายกับผู้ป่วย :<br>
    ...
    ?>
      ...
      <button class="btn btn-default" ><a href="sym_toxin_animal.php">กลับไปยังหน้าเริ่มต้น</a></button>
    </div> <!-- /container -->
    <hr width="75%">
