...
<html lang="en">
  ...
  <body>
    ...
    <!-- Static navbar --><br><br><br><br><br><br>
  	<hr width="75%">


 <center>
 		<b>สมัครสมาชิก</b>
        <form class="form-inline" role="form" action="user_regis_check.php" method="POST">
        <div class="form-group">
            <label for="nickname" style="font-size:20px"><button type="button" class="btn btn-success">nickname</button></label> :
            <input type="text" class="form-control" id="nickname" name="nickname" size="20" placeholder="nickname"autofocus required><br>
        ...
        <a href="user_login.php" > <input type="button" class="btn btn-danger" name="register" value="กลับไปหน้า Login"></a>
    </form><br>
