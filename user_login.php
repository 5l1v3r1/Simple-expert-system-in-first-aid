...
<html lang="en">
 ...
 <center>
 		<b>เข้าสู่ระบบ</b>
        <form class="form-inline" role="form" action="user_check.php" method="POST">
        ...
        <a href="user_register.php" target="_blank"> <input type="button" class="btn btn-danger" name="register" value="สมัครสมาชิก"></a>
    </form><br>
