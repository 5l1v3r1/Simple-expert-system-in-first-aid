  ...
  <ul class="dropdown-menu">
    ...
    <div class="container">
      ...
      <div class="jumbotron">
        <h2>สารพิษ (เคมี)</h2>
        <p>
        	โปรดเลือกลักษะอาการย่อย ของผู้ป่วยตามหัวข้อด้านล่างนี้
...
<div class="jumbotron">
        ...
        <form action="sym_toxin_chemis_result.php" method="GET">
    ...
    <button class="btn btn-default" ><a href="sym_toxin_chemis.php">ย้อนกลับ</a></button> 
