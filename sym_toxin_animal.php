  ...
  <ul class="dropdown-menu">
    ...
    <div class="container">
      ...
      <div class="jumbotron">
        <h2>สารพิษ (สัตว์)</h2>
         <p>
            โปรดเลือกชนิดของสัตว์ที่ทำอันตรายกับผู้ป่วย
        </p>
      </div>
      ...
      <div class="container">
        ...
        <?php
          ...
          $sql = "SELECT case_name,case_info FROM sym_cases_level1 where sym_id=3";
      ...
      <div class="jumbotron">
        ...
        <form action="sym_toxin_animal_result.php" method="GET">
